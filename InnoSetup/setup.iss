...
#define MyAppVersion ''
#define MyAppVerInfo ''
#define CompiledPath 'E:\Development\Visual Studio 2010\Projects\NBA 2K13 Keep My Mod\NBA 2K13 Keep My Mod\bin\Release'
[Setup]
...
[Files]
Source: "{#CompiledPath}\*"; DestDir: "{app}"; Flags: ignoreversion; Excludes: "*.vshost.*,*.xml"
...
begin
    ...
    sTemp := ExpandConstant('{pf32}') + '\NBA 2K13 Keep My Mod';

    //We need to get the current install directory.  
    if RegQueryStringValue(HKEY_LOCAL_MACHINE, 'Software\Lefteris Aslanoglou\NBA 2K13 Keep My Mod',
