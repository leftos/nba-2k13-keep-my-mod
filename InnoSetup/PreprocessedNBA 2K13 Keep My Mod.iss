...
[Setup]
AppName=NBA 2K13 Keep My Mod
AppVersion=
AppVerName=NBA 2K13 Keep My Mod  
...
;AppSupportURL=http://...
;AppUpdatesURL=http://...
OutputBaseFilename=NBA 2K13 Keep My Mod Setup
DefaultGroupName=NBA 2K13 Keep My Mod
DefaultDirName={code:GetDefaultDir}
UninstallDisplayIcon={app}\NBA 2K13 Keep My Mod.exe
UninstallDisplayName=NBA 2K13 Keep My Mod
Uninstallable=true
DirExistsWarning=no
CreateAppDir=true
OutputDir=..
...
[Files]
Source: "E:\Development\Visual Studio 2010\Projects\NBA 2K13 Keep My Mod\NBA 2K13 Keep My Mod\bin\Release\*"; DestDir: "{app}"; Flags: ignoreversion; Excludes: "*.vshost.*,*.xml"
[Icons]
...
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\NBA 2K13 Keep My Mod"; Filename: "{app}\NBA 2K13 Keep My Mod.exe"; WorkingDir: "{app}"; IconFilename: "{app}\NBA 2K13 Keep My Mod.exe"; Tasks: quicklaunchicon
[Run]
...
Root: "HKCU"; Subkey: "Software\Lefteris Aslanoglou\NBA 2K13 Keep My Mod"; ValueType: string; ValueName: "InstallDir"; ValueData: "{app}"
[Dirs]
Name: "{app}\Images"
[Files]
